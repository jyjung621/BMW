...
<header><%@ include file="../partials/header.jsp" %></header>
	<div id="page-wrapper">
		...
		<section id="main">
			<div class="container">
				<div class="row">
					<c:set var="id" value="memid" />
				</div>
				<!-- <section id="login"> -->
				<section>
					<div class="header">
						<h1>
							<a href='myPageForm.do'>My Page</a>
						</h1>
						<p>프로필 사진</p>
						...
						<div class="col-6 col-12-small">
							<div class="card"
								...
								<div class="card-body">
									...
									<a href="/BMW/member/ReviewList.do?memberId=memid" class="btn btn-primary" style="color: black;">바로가기</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-6 col-12-small">
							<div class="card"
								...
								<div class="card-body">
									...
									<a href="/BMW/member/CommentsList.do?memberId=memid"
						...
						<div class="col-6 col-12-small">
							<div class="card"
								...
								<div class="card-body">
									...
									<a href="/BMW/member/KJWupdateForm.do?memberId=memid"
										class="btn btn-primary" style="color: black;">바로가기</a>
								</div>
							</div>
						</div>

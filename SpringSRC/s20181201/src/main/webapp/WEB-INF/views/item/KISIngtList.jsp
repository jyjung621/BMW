								...
								<c:choose>
									<c:when test="${ingt.keyword == null}">
										<c:if test="${pg.startPage > pg.pageBlock}">
											<li><a href="KISIngtList.do?currentPage=${pg.startPage - pg.pageBlock}">«</a></li>
										</c:if>
										<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
											<li><a href="KISIngtList.do?currentPage=${i}">${i}</a></li>
										</c:forEach>
										<c:if test="${pg.endPage < pg.totalPage}">
											<li><a
												href="KISIngtList.do?currentPage=${pg.startPage + pg.pageBlock}">»</a></li>
										</c:if>
									</c:when>
									<c:otherwise>
										<c:if test="${pg.startPage > pg.pageBlock}">

...
//			getMaxNoForTable(String tableName, String referenceTable, int mainNo)
	...
	public Comments selectReview(int mainNo, int subNo, String ref_Table) throws SQLException {
		Comments comm = null;
		comm = selectComment(mainNo, subNo, ref_Table);

		List<SaveFiles> fileList = SaveFilesDao.getInstance().list(mainNo, subNo, "comments");
		comm.setSaveFileList(fileList);

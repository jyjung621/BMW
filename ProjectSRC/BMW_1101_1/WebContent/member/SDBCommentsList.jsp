...
<body>
	...
	<div class="topnav">
		<a href="/BMW/index.jsp">홈으로</a>
		<a href="clipList.do">나의 스크랩</a>
		<a href="">내가 쓴 리뷰</a>
		<a href="#">내가 쓴 댓글</a>
		<a href="/BMW/member/KJWupdateForm.do?memberId=<%=id%>">회원정보수정</a>
		<a href="deleteForm.do">회원탈퇴</a>
		<a href="<%=siteUrl%>/member/KJWlogout.jsp">로그아웃</a>
	</div> --%>
	<h2>댓글 목록</h2>
	<table>
		<tr>
		...
		<c:if test="${totCnt > 0 }">
			<c:forEach var="comments" items="${list }">
				<tr>
					...
					<td>${comments.regDate}<input type="button" value="삭제" onClick="del_chk(${comments.mainNo}, ${comments.subNo}, '${comments.ref_Table }')"></td>
				</tr>

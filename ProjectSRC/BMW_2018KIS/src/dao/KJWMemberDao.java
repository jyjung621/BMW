		...
		try {
			...
			if (rs.next()) {
				if (rs.getString(1).equals(passwd)) {
					...
					System.out.println("결과값 받고 -> " + memberId);
					System.out.println("결과값 받고 -> " + passwd);
					System.out.println("결과값 받고 -> " + rs.getString("nickname"));
					System.out.println("결과값 받고 -> " + rs.getString("grade"));
				}
				else					
					result = 0;
			} else

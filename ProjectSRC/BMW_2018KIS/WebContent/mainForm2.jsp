...
<body style="margin: auto;">
	...
	<div id="page-wrapper">
		...
		background-image: url('/BMW/images/rankingBanner/1337x573.png');">
			<banner0 class="major">
			<h2>유저들이 평가한 TOP8</h2>
			</banner0>
			<div class="container">
								...
								<div class="col-md-3 col-sm-3 col-xs-12">
									<div class="slider-item">
										<div class="slider-image">
											<a
												href="/BMW/item/ItemContent.do?itemNo=${list.get(0).getItemNo() }">
												<img src="/BMW/images/${list.get(0).getName() }.jpg"
									...
									<div class="slider-item">
										<div class="slider-image">
											<a
												...
												<img src="/BMW/images/${list.get(1).getName() }.jpg"
												width="250" height="200" class="img-responsive" alt="a" />
											</a>
										</div>
										<div class="slider-main-detail">
									...
									<div class="slider-item">
										<div class="slider-image">
											<a
												...
												<img src="/BMW/images/${list.get(2).getName() }.jpg"
												width="250" height="200" class="img-responsive" alt="a" />
											</a>
										</div>
										<div class="slider-main-detail">
									...
									<div class="slider-item">
										<div class="slider-image">
											<a
												...
												<img src="/BMW/images/${list.get(3).getName() }.jpg"
												width="250" height="200" class="img-responsive" alt="a" />
											</a>
										</div>
										<div class="slider-main-detail">
									...
									<div class="slider-item">
										<div class="slider-image">
											<a
												...
												<img src="/BMW/images/${list.get(4).getName() }.jpg"
												width="250" height="200" class="img-responsive" alt="a" />
											</a>
										</div>
										<div class="slider-main-detail">
									...
									<div class="slider-item">
										<div class="slider-image">
											<a
												...
												<img src="/BMW/images/${list.get(5).getName() }.jpg"
												width="250" height="200" class="img-responsive" alt="a" />
											</a>
										</div>
										<div class="slider-main-detail">
									...
									<div class="slider-item">
										<div class="slider-image">
											<a
												...
												<img src="/BMW/images/${list.get(6).getName() }.jpg"
												width="250" height="200" class="img-responsive" alt="a" />
											</a>
										</div>
										<div class="slider-main-detail">
									...
									<div class="slider-item">
										<div class="slider-image">
											<a
												...
												<img src="/BMW/images/${list.get(7).getName() }.jpg"
												width="250" height="200" class="img-responsive" alt="a" />
											</a>
										</div>
										<div class="slider-main-detail">
									...
									<div class="row">
										<div class="col-6 col-12-small">
											<section class="box">
												...
												<a href='/BMW/board/boardContent.do?boardNo=${list2.get(i).getBoardNo() }'><p>${list2.get(i).getContent()}</p></a>
												<footer>
													<ul class="actions">
										...
										<div class="col-6 col-12-small">
											<section class="box">
												...
												<a href='/BMW/board/boardContent.do?boardNo=${list2.get(i+1).getBoardNo() }'><p>

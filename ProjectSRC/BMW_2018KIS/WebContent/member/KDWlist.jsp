...
<body>
	<h1>
		<a href="../index.jsp">BMW</a>
	</h1>
	<table>
		<tr>
			<td>
				<div>
					<a href="KDWlist.do?pageNum=${pageNum}">회원 리스트</a>
					<p>
						<a href="../item/ItemList.do?pageNum=${pageNum}">제품 리스트</a>
					<p>
						<a href="../item/IngtList.do?pageNum=${pageNum}">성분리스트</a>
					<p>
						<a href="../board/boardList.do?pageNum=${pageNum}">게시판 관리</a>
				</div>
			</td>
		</tr>
	</table>
	<form action="KDWlist3.do" method="get">
			...
			<c:when test="${search != null }">
				<div style="text-align: center;">
					...
					<c:forEach var="i" begin="${startPage }" end="${endPage}">
						<a href='KDWlist3.do?pageNum=${i}&search=${search}&find=${find}'>[${i}]</a>
					</c:forEach>

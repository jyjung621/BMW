							...
							<td style="background-color: #f7f7f7; ">
								<div class="header">
									<div class="title2">
										...
										<a href="KDWlist.do?pageNum=${pageNum}" class="content"><button>회원리스트</button>
										</a> <a href="../item/itemIndex.jsp?pageNum=${pageNum}"
											class="content"><button>제품 리스트</button> </a> <a
											href="../item/IngtList.do?pageNum=${pageNum}" class="content"><button>성분리스트</button></a>
											 <a href="../board/boardList.do?boardCategory=자유"
											class="content"><button>게시판 관리</button></a>
									</div>
								</div>
							</td>
						</tr>

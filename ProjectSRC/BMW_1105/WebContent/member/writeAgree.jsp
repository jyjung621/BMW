...
<div id="page-wrapper">
	...
	<form action="writeForm.jsp" name="form" method="post">
		<table>
			<tr>
				<td width="100%" height="100%"><span style="padding-left: 160px">
				<!-- <img src="" width="290" height="100" border="0" align="middle"></span>&nbsp; --> 
			</tr>
			<tr>
				<td width="100%" height="100%" align="center">
					<p align="left">
						<!-- <img src ="/BMW/images/darkpinkAgree.png" width="100" height="auto" style="margin-left: 100px"> -->
...
(시행일) 이 약관은 2019년 01월부터 시행합니다.
			...
			<tr>
				<td align="center" valign="top">
					...
					<input type="button" value="거부" onclick="nochk()" />
				</td>
			</tr>
		</table>
	</form>

...
function changeList() {
	...
	var cateParent = $('#category option:selected').val();
	var cate = cateParent;
	if(cateParent != 0){
		cate = $('#category2 option:selected').val();	
	}
...
<div id="page-wrapper">
	...
	<div align="right" style="float: right;">
		<select id="sorting" style="width:100px;height:30px;" onchange="changeList();">

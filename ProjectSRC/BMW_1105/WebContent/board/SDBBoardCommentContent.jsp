...
<script type="text/javascript">
	...
	function showHtml(data, commPageNum) {
		...
		$
				.each(
						data,
						function(index, comms) {
							console.log('showhtml...' + (index + 1));
							html += "<tr align='center' id='commt"
									+ (index + 1) + "'>";
							html += "<td>" + (index + 1) + "</td>";
							html += "<td>" + comms.memberId + "</td>";
							html += "<td align='left'>" + comms.content
									+ "</td>";
							let presentDay = comms.regDate;
							html += "<td>" + presentDay + "</td>";
							html += "<td><input type='button' value='수정' onclick='updateForm(`commt"
									+ (index + 1)
									+ "`,"
									+ comms.mainNo
									+ ","
									+ comms.subNo + "," + commPageNum + ")'>";

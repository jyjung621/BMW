		...
		$.each(data, function(index, comms) {
					console.log('showhtml...' + (index+1));
							...
							html += "<td>" + presentDay + "</td>";
 							html += "<td>";
							html += "<input type='button' class='btn btn-default' value='수정' onclick='updateForm(`commt"
 								 	+ (index + 1) + "`,"
									+ comms.mainNo + ","
									+ comms.subNo + ","
									+ commPageNum + ")'>";
 							html += "<input type='button' class='btn btn-default' value='삭제' onclick='deleteComment("
									+ comms.mainNo + ","
									+ comms.subNo + ","
									+ commPageNum + ")'>";
							html += "</td>";
	...
	function updateForm(id, mainNo, subNo, commPageNum) {
		...
		$.ajax({
			...
			success : function(data) {
				...
				html += "<td><input type='button' class='btn btn-default' value='수정' onclick='updateCommentPro(" + data[0].mainNo + "," + data[0].subNo + "," + data[2] + ")'></td>";
